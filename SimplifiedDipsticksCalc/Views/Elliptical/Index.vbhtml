...
@Code
    ViewBag.Title = "Elliptical Tank Calculator"
End Code

<br />
<div class="row">
    <div class="col-md-12">
        <h2>Elliptical Tank Calibration</h2>
        <p class="lead">Calculate dipstick calibration tables for elliptical cross-section tanks.</p>
    </div>
</div>

@Html.ValidationSummary(False, "", New With {.class = "alert alert-danger"})

<form action="@Url.Action("Calculate", "Elliptical")" method="post">
    <div class="row">
        <div class="col-md-6">
