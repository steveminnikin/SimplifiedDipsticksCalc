    ...
    <div class="form-horizontal">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    @Html.TextBoxFor(Function(model) model.hopperVolume, New With {.class = "form-control"})
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    @Html.TextBoxFor(Function(model) model.dipHeightBelowBase, New With {.class = "form-control"})
